...
<video id="myVideo" width="640" height="480" autoplay loop>
...
Hence, new generation of marine scientists need to be well trained in
...
```{r, fig.width=12, fig.height=4, fig.align="left", tidy=TRUE}
# comment
p_all <- methods_now %>%
  ggplot(aes(x = selections, y = percent, fill = selections)) +
    ...
    guides(fill = "none") +
    labs(x = "Methods used", y = "Percent", title = "All working environments") + 
    coord_flip() + 
    theme_classic()
p_acad <- methods_now_acad %>%
  ggplot(aes(x = selections, y = percent, fill = selections)) +
    ...
    scale_fill_viridis_d(direction = -1) +
    guides(fill = "none") +
    labs(x = "Methods used", y = "Percent", title = "Academia") + 
    coord_flip() + 
    theme_classic()
...
[^2]: Davenport, Thomas H.; Patil, DJ (Oct 2012), [Data Scientist: The Sexiest Job of the 21st Century](https://hbr.org/2012/10/data-scientist-the-sexiest-job-of-the-21st-century), Harvard Business Review
