...
# INDperform <img src="/blog/2019-01-07-release-indicator-package-indperform_files/INDperform_logo.png" align="right" width="100" height="112" />

## Overview

[INDperform](https://cran.r-project.org/package=INDperform) is an R package that implements a quantitative framework for selecting and validating the performance of state indicators tailored to meet regional conditions and specific management needs as described in Otto *et al.* (2018) ^[Otto, S.A., Kadin, M., Casini, M., Torres, M.A. & Blenckner, T. (2018). A quantitative framework for selecting and validating food web indicators. Ecological Indicators, 84, 619-631, doi: [10.1016/j.ecolind.2017.05.045](https://doi.org/10.1016/j.ecolind.2017.05.045)] (see also my [post on indicators](/blog/2018/10/16/testing-indicator-performance/index.html)). 
...
Install the development version from Github using devtools or CRAN:
...
<div align="center">
<img class="img-external" src="/blog/2019-01-07-release-indicator-package-indperform_files/spiechart.png" width="50%" height="auto">
</div>
